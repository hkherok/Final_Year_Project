                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='main_form'>
                            <div className='district'>
                                <label>আপনার জেলা নির্বাচন করুনঃ</label>
                ...
                {submitting &&
                    <div className='result'>
                        ...
                        <table>
                            ...
                            <tbody>
                                {Calculator(formData['district'], parseFloat(formData['land']))}
...
function Calculator(district, land) {
    ...
    console.log(seed);
    seed.area = district;
    seed.urea = parseFloat(seed.urea) * parseFloat(land);
    seed.tsp = parseFloat(seed.tsp) * parseFloat(land);
    seed.mop = parseFloat(seed.mop) * parseFloat(land);
    seed.gipsam = parseFloat(seed.mop) * parseFloat(land);
    seed.zinc = parseFloat(seed.zinc) * parseFloat(land);
    ...
    finalProcess[1][0] = "চারা বপন শুরু"; finalProcess[0][1] = seed['Seed_sowing_first_date'] + ", " + ;
    finalProcess[0][0] = "স্থান"; finalProcess[0][1] = seed['area'];
    finalProcess[0][0] = "স্থান"; finalProcess[0][1] = seed['area'];
    finalProcess[0][0] = "স্থান"; finalProcess[0][1] = seed['area'];
    finalProcess[0][0] = "স্থান"; finalProcess[0][1] = seed['area'];
